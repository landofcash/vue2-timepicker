    ...
    export default {
        ...
        data() {
            return {
                ...
                demoArgs: undefined,
                example1:{ HH: '01', mm: '10' },
                example2:{ hh: '01', mm: '10', A: 'AM'},
                example3:{ h: '1', m: '10', a: 'am'},
                example4:{ HH: '10', mm: '30', ss: '15' },
                example5:{ HH: '02', mm: '30' },
                example6:{ HH: '05', mm: '20', ss: '30' },
                example7:{ hh: '4', mm: '20', ss: '45' },
                example8:{ HH: '06', mm: '30' }
            }
        },
        methods: {
...
<template>
    <section id="mostlyUsedSamples">
        ...
        <div class="block">
            ...
            <div class="codes">
                <pre data-title="HTML"><code class="html">&lt;vue-timepicker v-model="example1" /&gt;</code></pre>
            </div>
            <div class="preview">
                <vue-timepicker v-model="example1"></vue-timepicker>
            </div>
        </div>
...
&lt;vue-timepicker format="h:m a" /&gt;
                ...
                <div class="preview">
                    ...
                    <p>
                        <vue-timepicker v-model="example2" format="hh:mm A"></vue-timepicker>
                    </p>
                    <b>12-hour sample 2</b>
                    <p>
                        <vue-timepicker v-model="example3" format="h:m a"></vue-timepicker>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="block">
            ...
            <div class="description">
                <p>You can trigger the seconds picker by adding <code>ss</code> or <code>s</code> in your format string.
                </p>
            </div>
            <div class="codes">
            ...
            <div class="preview">
                <vue-timepicker v-model="example4" format="HH:mm:ss"></vue-timepicker>
            </div>
        </div>
        ...
        <div class="block">
            ...
            <div class="description">
                <p>
                    Timepicker also allows you to display minutes or seconds picker with certain interval, like a 10-minute interval <code>0, 10, 20, ... 50, 60</code>
                    for example</p>
            </div>
            <div class="codes">
...
&lt;vue-timepicker format="hh:mm:ss" :minute-interval="5" :second-interval="10" /&gt;
            ...
            <div class="preview">
                ...
                <p>
                    <vue-timepicker v-model = "example5" :minute-interval="10"></vue-timepicker>
                </p>
                <b>15-second interval</b>
                <p>
                    <vue-timepicker v-model = "example6"  format="HH:mm:ss" :second-interval="15"></vue-timepicker>
                </p>
                <b>5-minute interval plus 10-second interval</b>
                <p>
                    <vue-timepicker v-model = "example7"  format="hh:mm:ss" :minute-interval="5" :second-interval="10"></vue-timepicker>
                </p>
            </div>
        </div>
        ...
        <div class="block">
            ...
            <div class="description">
                <p>Thanks to the awesome Vue2.0 feature, you can manipulate timepicker's data with <code>v-model</code>
                    now</p>
            </div>
            <div class="codes">
  ...
  yourData: {
    ...
    a: 'am'
        ...
        <div class="block">
            ...
            <div class="description">
                <p>If you don't want to expose the clear button in the UI, <code>hide-clear-button</code>
                    property will do the trick.</p>
            </div>
            <div class="codes">
                <pre data-title="HTML"><code class="html">&lt;vue-timepicker hide-clear-button /&gt;</code></pre>
            </div>
            <div class="preview">
                <vue-timepicker v-model = "example8" hide-clear-button></vue-timepicker>
            </div>
        </div>
